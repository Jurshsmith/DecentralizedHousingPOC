...
contract Ownable {
    ...
    // indexed because we want to easily filter the event on a web3 client
    ...
    modifier onlyOwner {
        require(msg.sender == _owner, "requires owner");
        _;
    }
...
contract ERC721 is Pausable, ERC165 {
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        emit Transfer(address(0), to, tokenId);// since no actual transfer happened
    }
...
//  s: Create CustomERC721Token contract that inherits from the ERC721Metadata contract. You can name this contract as you please
...
contract DecentralizedHousingToken is ERC721Metadata {
    string private _tokenName = "IDecentralizedHousingToken";
    string private _symbolName = "IDHT";
    string private _baseTokenURI =
